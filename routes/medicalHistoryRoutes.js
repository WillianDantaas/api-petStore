...
medicalHistoryRoutes.post('/medical-history', verifyToken, async (req, res) => {
   ...
   */
  medicalHistoryRoutes.get('/medical-history/:petId', verifyToken, async (req, res) => {
   ...
   */
  medicalHistoryRoutes.put('/medical-history/:id', verifyToken, async (req, res) => {
    const { id } = req.params;
